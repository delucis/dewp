...
3. You can now use Astro’s [content collection APIs](https://5-0-0-beta.docs.astro.build/en/guides/content-collections/) to get your WordPress data in your components. In the following example, the `posts` collection is loaded in order to display each post’s title:
